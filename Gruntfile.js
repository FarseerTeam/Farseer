...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,api,components}/**/*.js',
          '!<%= yeoman.client %>/{app,api,components}/**/*.spec.js',
          '!<%= yeoman.client %>/{app,api,components}/**/*.mock.js',
    ...
    buildcontrol: {
      ...
      heroku: {
        options: {
          remote: 'git@heroku.com:armored-farseer.git',
          branch: 'master'
        }
      },
      openshift: {
